...
class ReviewScoreDialog(BaseDialog):
    ...
    def create_body(self):
        ...
        scores = {
            5: ("Perfecto", "#2E7D32"),
            4: ("Dudé un poco", "#689F38"),
            3: ("Con dificultad", "#1976D2"),
            2: ("Incorrecto (fácil)", "#F57C00"),
            1: ("Incorrecto (recordé)", "#D32F2F"),
            0: ("No recordé nada", "#C62828")
        }
        ...
        for score, (text, color) in scores.items():
            ...
            btn.pack(padx=7, pady=5, ipady=5)
